...
#classe fille de recognizer
#il va reconnaitre les entités et les intentions avec LUIS
# https://docs.microsoft.com/en-us/composer/concept-dialog?tabs=v2x
class FlightBookingRecognizer(Recognizer):
    #prend comme parametre la config et le client de telemetry
    def __init__(
        self, configuration: DefaultConfig, telemetry_client: BotTelemetryClient = None
    ):
        self._recognizer = None
         #on recupere les infos de LUIS
        luis_is_configured = (
